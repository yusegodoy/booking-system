@echo off
title Booking System - Starting Services
color 0A

echo.
echo ========================================
echo    BOOKING SYSTEM - STARTING SERVICES
echo ========================================
echo.
...
if %errorlevel% neq 0 (
    ...
    echo    Please make sure MongoDB is installed and in your PATH
    echo    Or start MongoDB manually from MongoDB Compass
    echo.
    pause
    exit /b 1
) else (
