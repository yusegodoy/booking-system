...
async function testNewPricingLogic() {
  console.log('🧪 Testing New Pricing Logic (Base Threshold + Tiers)...\n');

  const testCases = [
    {
      name: 'Short distance (10 miles) - Within base threshold',
      miles: 10,
    ...
    {
      name: 'Medium distance (20 miles) - Exceeds base threshold',
      miles: 20,
      expectedBasePrice: 55,
    ...
    {
      name: 'Long distance (71.4 miles) - Exceeds base threshold significantly',
      miles: 71.4,
      expectedBasePrice: 55,
  ...
  console.log('🎯 New Pricing Logic Test Completed!');
  ...
  console.log('   • X = baseDistanceThreshold (configurable, default: 12 miles)');
  console.log('   • Tiers apply only to miles beyond the base threshold');
}

// Run the test
testNewPricingLogic().catch(console.error); 