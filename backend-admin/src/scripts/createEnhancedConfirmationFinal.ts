...
async function createEnhancedConfirmationFinal() {
  try {
    ...
    console.log('📧 Updating Confirmation Final with enhanced design...');

    // Update with enhanced template
    existingTemplate.htmlContent = getEnhancedHTMLTemplate();
    existingTemplate.textContent = getEnhancedTextTemplate();
    ...
    console.log('✅ Enhanced Confirmation Final template updated successfully');
    ...
    console.log('   - HTML Content: ' + getEnhancedHTMLTemplate().length + ' characters');
    console.log('   - Text Content: ' + getEnhancedTextTemplate().length + ' characters');

    // Verify the template was updated
    const verifyTemplate = await EmailTemplate.findOne({ name: 'Confirmation Final' });
    if (verifyTemplate) {
      console.log('\n✅ Verification successful: Enhanced template updated');
...
function getEnhancedHTMLTemplate(): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="booking-details">
                ...
                <div class="details-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{passengers}} {{passengers === '1' ? 'person' : 'people'}}</div>
                    </div>
...
function getEnhancedTextTemplate(): string {
...
// Run the script
createEnhancedConfirmationFinal();
